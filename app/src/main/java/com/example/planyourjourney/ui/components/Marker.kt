package com.example.planyourjourney.ui.components
...
internal fun rememberMarker(): Marker {
    ...
    val indicatorInnerComponent = shapeComponent(shape = Shapes.pillShape, color = MaterialTheme.colorScheme.surface)
